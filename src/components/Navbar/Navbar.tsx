...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center justify-between flex-wrap bg-custom-green-primary">
                ...
                <div>
                    {user.id ? (
                        <button
                            ...
                            className="inline-block text-sm px-4 py-2 leading-none border rounded text-custom-yellow-primary border-white hover:border-transparent hover:text-custom-yellow-primary hover:bg-white mt-4 lg:mt-0"
                        >
                            Logout
                        </button>
                    ) : (
